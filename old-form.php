...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6"><img class="img-fluid mb-3" src="logo1-w.png" style="width: 200px;"></div>
    ...
    <div class="form-w" id="msform">
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <p><span class="wpcf7-form-control-wrap" data-name="menu-51"><select
                                            aria-invalid="false" class="wpcf7-form-control wpcf7-select form-control"
                                            name="lane_count"><option value="1">1</option><option value="2">2</option><option
        ...
        <fieldset id="laststep" style="display:none;">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 pb-3">
                    <input aria-invalid="false" class="wpcf7-form-control wpcf7-email wpcf7-text wpcf7-validates-as-email form-control"
                           name="email" autocomplete="email" placeholder="Email" size="40" type="email" value="" required></div>
                <div class="col-lg-4 col-md-4 pb-3">
                    <input aria-invalid="false" class="wpcf7-form-control wpcf7-tel wpcf7-text wpcf7-validates-as-tel form-control" name="phone" placeholder="Phone" size="40" type="tel" value="" required>
                </div>
            </div>

            <div class="col-lg-12 col-md-12 px-0 pb-3">
                <textarea aria-invalid="false" class="wpcf7-form-control wpcf7-textarea form-control" cols="40" name="message" placeholder="Message" rows="5" required></textarea>
            </div>
            ...
            <p>
                ...
                <input class="wpcf7-form-control wpcf7-submit has-spinner action-button" type="submit" value="Submit">
...
<footer id="main-footer">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3"><h4 class="title">Quick Link</h4>
            ...
            <div class="col-lg-3 col-md-3"><h4 class="title">Contact Us</h4>
                <p><b>Address:</b> 1241 5th Avenue, Prince George, BC, V2L 3L3</p>
                <p><b>Phone:</b> 250-564-2695</p>
                <p><b>Email:</b> blackdiamondbb2018@gmail.com</p>
            </div>
